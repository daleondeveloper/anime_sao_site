...
public class SaoSiteApplication {
    ...
    public CommandLineRunner demo(final UserServiceImpl userServiceImpl,
                                  ...
                                  final AnimePublicationService animePublicationService) {
...
////                        File infoFile = dbFileStorageService.storeFile(new ImagePublication("avatar", "image/jpg", image1, RoleEnum.ROLE_GUEST, new AnimePublication()));
////                        ImagePublication imagePublication = new ImagePublication(infoFile.getFileName(), infoFile.getContentType(), infoFile.getData(), RoleEnum.ROLE_GUEST, animePublication);
////                        animePublicationService.addInfoImage(animePublication.getId(), imagePublication);
//                    }
//                    if(j == 6 )j = 0;
//                }
            }
